...
RUN apt-get update
# RUN apt-get install -y python-pyusb python-pytz python-pyserial python-jcconv python-ebaysdk
...
RUN pip install ebaysdk jcconv pyserial pytz pyusb suds-jurko pip install Python-Chart pip install num2words pip install pyPdf pip install pyyaml pip install html2text pip install ninja2 pip install gdata pip install chardet pip install libsass
