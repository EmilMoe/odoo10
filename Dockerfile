...
RUN pip install ebaysdk jcconv pyserial pytz pyusb suds-jurko Python-Chart pip install num2words pip install pyPdf pip install pyyaml pip install html2text pip install ninja2 pip install gdata pip install chardet pip install libsass
